     ...
     if (htim->Instance == TIM2)
     {
         ...
         if (htim->Instance == TIM3)
              {
                  if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_1)
                  {
                      ...
                      if (capture_value[1])
                      {
                          frequency[1] = SystemCoreClock / capture_value[1];
                          duty_cycle[1] = 10000 * HAL_TIM_ReadCapturedValue(htim, TIM_CHANNEL_2) / capture_value[1];
                      }
                  }}
        if (htim->Instance == TIM4)
                  ...
                  if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_1)
                  {
                      ...
                      if (capture_value[2])
                      {
                          frequency[2] = SystemCoreClock / capture_value[2];
                          duty_cycle[2] = 10000 * HAL_TIM_ReadCapturedValue(htim, TIM_CHANNEL_2) / capture_value[2];
                      }
                  }  }
                 ...
                 if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_1)
                  {
                      ...
                      if (capture_value[3])
                      {
                          frequency[3] = SystemCoreClock / capture_value[3];
                          duty_cycle[3] = 10000 * HAL_TIM_ReadCapturedValue(htim, TIM_CHANNEL_2) / capture_value[3];
                      }
                   }
